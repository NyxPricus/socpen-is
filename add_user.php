      ...
      <div class="card card-register mx-auto mt-5">
		...
		<?php }else
		{
          ...
          <form method="POST" action="admin_reg_user.php">
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="text" id="inputAddress" name="inputAddress" placeholder="Address" value="<?php echo $inputEmail; ?>" required="required" <?php echo (isset($_SESSION["register_field"]) && $_SESSION["register_field"] == "ADRESS")? 'class="form-control is-invalid" autofocus="autofocus"':'class="form-control"'?>>
