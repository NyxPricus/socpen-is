...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$register_data = array($username,$firstName,$lastName,$userEmail,$address,$utype);	
	...
	if($stmt = $mysqli->prepare($sql)){
		...
		$paramuType = $utype; //default(for activation by admin)
		...
		if($stmt->execute()){
			...
			$_SESSION["register_failure"] = "SAVED!";
			header("location:add_user");
		} else{
