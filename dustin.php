...
while($row = $result->fetch_assoc()){
    ...
    <tr>
      <td><?php echo $rank?></td>
      <?php if($rank==1){ ?>
        <td><b><?php echo $uname?></b><img src="piksur/m.png" title="MYTHIC" style="width: 100px;height: 100px"></td>
		<?php }elseif($rank==2){ ?>
        <td><?php echo $uname ?><img src="piksur/Legend.png" title="LEGEND" style="width: 60px;height: 60px"></td>
      <?php }elseif($rank==3){ ?>
        <td><?php echo $uname ?><img src="piksur/e.png" title="EPIC" style="width: 60px;height: 60px"></td>
      <?php }elseif($rank==4){ ?>
        <td><?php echo $uname?><img src="piksur/gm.png" title="GRAND MASTER" style="width: 60px;height: 60px"></td>
		<?php }elseif($rank==5){ ?>
        <td><?php echo $uname?><img src="piksur/master.png" title="MASTER" style="width: 60px;height: 60px"></td>
    <?php }elseif($rank==6){ ?>
        <td><?php echo $uname?><img src="piksur/elite.png" title="ELITE" style="width: 60px;height: 60px"></td>
	<?php }elseif($rank==7){ ?>
        <td><?php echo $uname?><img src="piksur/warrior.png" title="WARRIOR" style="width: 60px;height: 60px"></td>
    <?php }elseif($rank==8){ ?>
        <td><?php echo $uname?> &nbsp <img src="piksur/mi.png" title="NAKU PO MINION!" style="width: 35px;height: 40px"></td>
		 <?php }elseif($rank==9){ ?>
        <td><?php echo $uname?> &nbsp <img src="piksur/mi.png" title="NAKU PO MINION!" style="width: 35px;height: 40px"></td>
		 <?php }elseif($rank==10){ ?>
        <td><?php echo $uname?> &nbsp <img src="piksur/mi.png" title="NAKU PO MINION!" style="width: 35px;height: 40px"></td>
