      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Beneficiaries that has Change Grantee</li>
          </ol>

          <!-- DataTables Example -->
		   <div class="card mb-3">
 <div class="card-header">
			<b>Beneficiaries that has Change in Grantee</b>
			</div>
			  <div class="card-body">
	...
	//	$id = $_POST['historyID'];
		//echo $id;
		$typeofupdate = "Change Grantee";
  $sql="SELECT id,concat(first_name,' ',middle_name,' ',last_name) as fullname,hhid,concat(purok_sitio,' ',barangay, ' ',city_muni,' ',province) as address, count(hhid) as bilang FROM uct_list_edit_history where type_of_update = 'Change Grantee' group by hhid order by edit_id desc";
