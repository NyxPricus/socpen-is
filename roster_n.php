...
<html lang="en">
  ...
  <head>
    ...
    <title>UCT - LISTAHANAN | ROSTER NAME</title>
...
legend.scheduler-border {
    ...
    <legend class="scheduler-border">Filter using Roster Member</legend>
					<label for = "txthhid">Enter Name:</label>
					<input required type = "text" class = "form-control" name = "txthhid" placeholder = "Enter full hhid or last 8 digits on the right"/>
					<button type ="submit" name = "r_key" class = "btn btn-info form-control"><span class="fas fa-filter"></span>&nbsp;Filter by Roster Member</button>
