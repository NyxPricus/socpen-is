...
if($stmt = $mysqli->prepare($sql)){
	...
	if($stmt->execute()){
		...
		$url="paid_tagging.php";
			$_SESSION["register_failure"] = $h_hhid . "This HHID was already tagged with the same year by user id:". $user['userName'];
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">TAG AS UNPAID?</h5>
        <form action="tag_unpaid_function.php" method="POST" name="paid-modal" id="paid-modal">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" id = "myButt" name="myButt" ><i class="fas fa-money-bill"></i>&nbsp;UNPAID&nbsp;<?php if($_SESSION['taon']==2018){echo "2,400?";}else echo "3,600?"; ?></button>
</form>
      </div>
    </div>
  </div>
