        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="#">Number of Unpaid beneficiaries</a>
            </li>
									 ...
									 <h3><?php echo $year; ?></h3>
									 <h6><i>*click on the unpaid figures to view the breakdown on unpaid per municipality</i></h6>
													<table class = "table">
													...
													<?php	$sql="SELECT ul.province, count(ul.hhid) as target
												...
												if($stmt = $mysqli->prepare($sql)){
													...
													if($stmt->execute()){
														$stmt->store_result();
														if($stmt->num_rows != 0){                    
														$stmt->bind_result($province,$target);
															while($stmt->fetch()){
															$unpaid = getCountUnpaid($mysqli,$province,"2018");
															$paid = $target - $unpaid;
															$per = ($paid / $target) * 100;
														...
														<td><?php echo $paid?></td>
														<td><a href = "breakdown.php?province=<?php echo $province?>&year=<?php echo $year?>" target ="_BLANK"><?php echo $unpaid?></a></td>
														<td><?php echo $per?>%</td>
